...
//	void saveZimages(std::vector<volumetype> indices, std::string prefix);
    ...
    void setLoopClosureEnable(bool enable){_loopClosureEnabled=enable;}
    void setLoopClosureLogging(bool logging){_loopClosureLogging=logging;}
    void setLoopClosureMode(bool mode){_loopClosureMode=mode;}
